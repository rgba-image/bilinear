...
describe( 'bilinear', () => {
  ...
  it( 'resizes up', () => {
    ...
    bilinear( pattern, patternDouble )
  ...
  it( 'resizes region down', () => {
    ...
    bilinear( patternBorder, patternHalfRegion, 2, 2, 8, 8, 1, 1, 4, 4 )
  ...
  it( 'resizes region up', () => {
    ...
    bilinear( patternBorder, patternDoubleRegion, 2, 2, 8, 8, 1, 1, 16, 16 )
  ...
  it( 'early return when any dimension is 0', () => {
    ...
    bilinear( destSw, pattern, 0, 0, 0, 8 )
    bilinear( destSh, pattern, 0, 0, 8, 0 )
    bilinear( destDw, pattern, 0, 0, 8, 8, 0, 0, 0, 8 )
    bilinear( destDh, pattern, 0, 0, 8, 8, 0, 0, 8, 0 )
  ...
  it( 'does not sample outside bounds', () => {
    ...
    bilinear( pattern, patternOutOfBounds, 0, 0, 16, 16, 0, 0, 32, 32 )
  ...
  it( 'big resize down', () => {
    ...
    bilinear( noise, dest, 0, 0, 2560, 2560, 0, 0, 1280, 1280 )
  } )
  ...
  it( 'big resize up', done => {
    ...
    bilinear( noise, dest, 0, 0, 2560, 2560, 0, 0, 3840, 3840 )
